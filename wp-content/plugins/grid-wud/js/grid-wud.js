...
(function($) { 
	...
	{		
		...
		var dataString = 'stickyleft='+ stickyleft + '& sticky='+ sticky + '& grid_wud_set_max_grid='+ ptotal + '& grid_wud_tags='+ ptags +'& grid_wud_cats='+ pcats +'& grid_wud_ids='+ ids+'& grid_wud_grid_nr='+ tnr+'& grid_wud_shape='+ snr+'& grid_wud_latest='+ lp+'& grid_wud_shadow='+ sh+'& posttype='+ posttype+'& tax_name='+ tax_name+'& pods_cat='+ pc+'& pods_is_used='+ pu+'& is_numbers='+ isnr+'& postids='+ isids+'& background='+ bg+'& order_by='+ ob+'& order_sort='+ so+'& tiles='+ tl;
