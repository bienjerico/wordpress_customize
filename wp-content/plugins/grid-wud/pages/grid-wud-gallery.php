    ...
    if($gwfuncs['grid_wud_url_gallery']==1 || $gwfuncs['grid_wud_lb_gallery']==1){	
	  $result .= "<a href='".get_attachment_link( $id )."' wud-lb='".$wud_feat_imagefat."' title='' alt='' >";
			...
			if($gwfuncs['gwcss'] == "4" ){
						...
						$result .= "<div class='grid-wud-wrapper grid-wud-wrapper-box' id='grid-".$gwfuncs['gwcss']."-wud-wrapper-".$wud_grid_nr."' style='z-index: ".$gwfuncs['grid_wud_round_index']."; border-radius: 50% !important;-webkit-border-radius: 50% !important;	-moz-border-radius: 50% !important; ' >"; 
						}
						//no shadow
						else{
			...
			//SQUARE ***
						...
						if($gwfuncs['grid_wud_shadow']==1){
						$result .= "<div class='grid-wud-wrapper grid-wud-wrapper-box' id='grid-".$gwfuncs['gwcss']."-wud-wrapper-".$wud_grid_nr."' style='z-index: ".$gwfuncs['grid_wud_round_index']."; border-radius:".$gwfuncs['grid_wud_round_img']."px; webkit-border-radius:".$gwfuncs['grid_wud_round_img']."px; moz-border-radius:".$gwfuncs['grid_wud_round_img']."px; ' >"; 	
						}
						//no shadow
						else{
						$result .= "<div class='grid-wud-wrapper' id='grid-".$gwfuncs['gwcss']."-wud-wrapper-".$wud_grid_nr."' style='z-index: ".$gwfuncs['grid_wud_round_index']."; border-radius:".$gwfuncs['grid_wud_round_img']."px; webkit-border-radius:".$gwfuncs['grid_wud_round_img']."px; moz-border-radius:".$gwfuncs['grid_wud_round_img']."px;  ' >"; 	
						}						
				}					
